...
[![Latest Stable Release](https://img.shields.io/github/v/release/pkgforge-dev/NewsFlash-AppImage)](https://github.com/pkgforge-dev/NewsFlash-AppImage/releases/latest)
